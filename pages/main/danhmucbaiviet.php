...
?>
<h3 class="content_title">Danh mục bài viết: <span><?php echo $row_title['tendanhmuc_baiviet'] ?></span></h3>
...
<div class="product_list">
	...
	?>
		<div class="product_item">
			...
			<a class="list-item" class="list_item" style="text-decoration: none;" href="index.php?quanly=baiviet&id=<?php echo $row_bv['id'] ?>">
